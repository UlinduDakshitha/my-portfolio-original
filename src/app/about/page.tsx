        ...
        <div className={`container section ${styles.aboutContainer}`}>
            <div className={`${styles.header} animate-fade-in`}>
                ...
                <p className={styles.intro}>
                    Motivated Software Engineering undergraduate blending full-stack web development with a strong passion for Artificial Intelligence, Deep Learning, and DevOps.
                </p>
            </div>
                ...
                <div className={`${styles.column} animate-fade-in delay-1`}>
                    ...
                    <div className={`${styles.card} glass hover-lift`}>
                        ...
                        <div className={styles.timelineItem}>
                            ...
                            <p className={styles.desc}>Delivered real-world training projects using Java Spring Boot, React.js, MySQL, REST API development, and AWS deployment.</p>
                        </div>
                        ...
                        <div className={styles.timelineItem}>
                            ...
                            <p className={styles.desc}>Coordinated logistics and on-site operations for the annual computing symposium.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className={`${styles.column} animate-fade-in delay-2`}>
                    <div className={`${styles.card} glass hover-lift`}>
                        ...
                        <div className={styles.skillGroup}>
                            ...
                            <div className={styles.tags}>
                                <span>Java</span><span>JavaScript</span><span>TypeScript</span>
                                <span>Spring Boot</span><span>React.js</span><span>Next.js</span>
                        ...
                        <div className={styles.skillGroup}>
                            ...
                            <div className={styles.tags}>
                                <span>MySQL</span><span>MongoDB</span><span>Git / GitHub</span>
                                <span>REST APIs</span><span>AWS</span><span>Postman</span>
                            </div>
                        </div>
                        ...
                        <div className={styles.skillGroup}>
                            ...
                            <div className={styles.tags}>
                                <span className={styles.highlightTag}>Artificial Intelligence (AI)</span>
                                <span className={styles.highlightTag}>Machine Learning (ML)</span>
                    ...
                    <div className={`${styles.card} glass hover-lift`}>
                        ...
                        <ul className={styles.certList}>
                            ...
                            <li>Critical Thinking in the AI Era — <span>HP LIFE, 2026</span></li>
                            <li>Git & GitHub for Beginners — <span>Udemy, 2025</span></li>
                        </ul>
                    </div>
                </div>
            </div>
